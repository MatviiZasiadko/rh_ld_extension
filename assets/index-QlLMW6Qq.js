...
var vf = V({}, Xt, {
  ...
  wf = ge(gf),
  Sf = V({}, lt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  kf = ge(Sf),
  Ef = V({}, el, {
    deltaX: function (e) {
...
function qs(e, n, t) {
  (we[Se++] = Ve), (we[Se++] = Ae), (we[Se++] = xn), (xn = e);
  var r = Ve;
  e = Ae;
  var l = 32 - Te(r) - 1;
  (r &= ~(1 << l)), (t += 1);
...
function zi(e, n, t, r, l) {
  ...
  if ((Xn(n, l), n.stateNode === null))
    _r(e, n), la(n, t, r), Su(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
  ...
  switch ((ro(n), n.tag)) {
    ...
    case 6:
      if (e && n.stateNode != null) ja(e, n, e.memoizedProps, r);
        ...
        if (((t = kn(At.current)), kn(je.current), cr(n))) {
          if (
            ((r = n.stateNode),
            (t = n.memoizedProps),
            (r[Ie] = n),
...
export { Ld as R, Io as c, Td as j, $u as r };
